...
/* bank type for non-alive type (Exynos9610)
 * (CON bit field: 4, DAT bit field: 1, PUD bit field: 4, DRV bit field: 4)
 * (CONPDN bit field: 2, PUDPDN bit field: 4)
 */
static struct samsung_pin_bank_type exynos9610_bank_type_off = {
	.fld_width = { 4, 1, 4, 4, 2, 4, },
	.reg_offset = { 0x00, 0x04, 0x08, 0x0c, 0x10, 0x14, },
};

/* bank type for alive type (Exynos9610)
 * (CON bit field: 4, DAT bit field: 1, PUD bit field: 4, DRV bit field: 4)
 */
static struct samsung_pin_bank_type exynos9610_bank_type_alive = {
	.fld_width = { 4, 1, 4, 4, },
	.reg_offset = { 0x00, 0x04, 0x08, 0x0c, },
};
...
static struct samsung_pin_bank_data exynos9610_pin_banks0[] __initdata = {
	EXYNOS8_PIN_BANK_EINTN(exynos9610_bank_type_alive, 6, 0x000, "etc0"),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 8, 0x020, "gpa0", 0x00, 0x00),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 8, 0x040, "gpa1", 0x04, 0x08),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 8, 0x060, "gpa2", 0x08, 0x10),
	EXYNOS8_PIN_BANK_EINTN(exynos9610_bank_type_alive, 5, 0x080, "gpq0"),
};

/* pin banks of exynos9610 pin-controller 1 (CMGP) */
static struct samsung_pin_bank_data exynos9610_pin_banks1[] __initdata = {
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x000, "gpm0", 0x00, 0x00),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x020, "gpm1", 0x04, 0x04),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x040, "gpm2", 0x08, 0x08),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x060, "gpm3", 0x0C, 0x0C),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x080, "gpm4", 0x10, 0x10),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x0A0, "gpm5", 0x14, 0x14),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x0C0, "gpm6", 0x18, 0x18),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x0E0, "gpm7", 0x1C, 0x1C),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x100, "gpm8", 0x20, 0x20),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x120, "gpm9", 0x24, 0x24),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x140, "gpm10", 0x28, 0x28),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x160, "gpm11", 0x2C, 0x2C),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x180, "gpm12", 0x30, 0x30),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x1A0, "gpm13", 0x34, 0x34),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x1C0, "gpm14", 0x38, 0x38),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x1E0, "gpm15", 0x3C, 0x3C),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x200, "gpm16", 0x40, 0x40),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x220, "gpm17", 0x44, 0x44),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x240, "gpm18", 0x48, 0x48),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x260, "gpm19", 0x4C, 0x4C),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x280, "gpm20", 0x50, 0x50),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x2A0, "gpm21", 0x54, 0x54),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x2C0, "gpm22", 0x58, 0x58),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x2E0, "gpm23", 0x5C, 0x5C),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x300, "gpm24", 0x60, 0x60),
	EXYNOS9_PIN_BANK_EINTW(exynos9610_bank_type_alive, 1, 0x320, "gpm25", 0x64, 0x64),
};

/* pin banks of exynos9610 pin-controller 2 (DISPAUD) */
static struct samsung_pin_bank_data exynos9610_pin_banks2[] __initdata = {
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 5, 0x000, "gpb0", 0x00, 0x00),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 4, 0x020, "gpb1", 0x04, 0x08),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 5, 0x040, "gpb2", 0x08, 0x0C),
};

/* pin banks of exynos9610 pin-controller 3 (FSYS) */
static struct samsung_pin_bank_data exynos9610_pin_banks3[] __initdata = {
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 4, 0x000, "gpf0", 0x00, 0x00),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 8, 0x020, "gpf1", 0x04, 0x04),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 6, 0x040, "gpf2", 0x08, 0x0C),
};

/* pin banks of exynos9610 pin-controller 4 (TOP) */
static struct samsung_pin_bank_data exynos9610_pin_banks4[] __initdata = {
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 8, 0x000, "gpp0", 0x00, 0x00),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 6, 0x020, "gpp1", 0x04, 0x08),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 8, 0x040, "gpp2", 0x08, 0x10),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 8, 0x060, "gpc0", 0x0C, 0x18),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 8, 0x080, "gpc1", 0x10, 0x20),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 5, 0x0A0, "gpc2", 0x14, 0x28),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 8, 0x0C0, "gpg0", 0x18, 0x30),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 8, 0x0E0, "gpg1", 0x1C, 0x38),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 8, 0x100, "gpg2", 0x20, 0x40),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 6, 0x120, "gpg3", 0x24, 0x48),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 3, 0x140, "gpg4", 0x28, 0x50),
};

/* pin banks of exynos9610 pin-controller 5 (SHUB) */
static struct samsung_pin_bank_data exynos9610_pin_banks5[] __initdata = {
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 4, 0x000, "gph0", 0x00, 0x00),
	EXYNOS9_PIN_BANK_EINTG(exynos9610_bank_type_off, 3, 0x020, "gph1", 0x04, 0x04),
};
